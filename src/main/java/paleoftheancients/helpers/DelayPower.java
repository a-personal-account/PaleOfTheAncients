...
public class DelayPower extends AbstractPower implements NonStackablePower {
    ...
    public static void addToBottom(AbstractPower pow, AbstractCreature source) {
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(pow.owner, source, pow));
    }
    public static void addToTop(AbstractPower pow, AbstractCreature source) {
        AbstractDungeon.actionManager.addToTop(new ApplyPowerAction(pow.owner, source, pow));
    }
}