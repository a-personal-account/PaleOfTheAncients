...
public class ScytheParticleEffect extends AbstractGameEffect {
    ...
    public ScytheParticleEffect(float x, float y) {
        this.scale = Settings.scale / 2.0F;
        this.duration = 2.0F;
        this.x = x;
        this.y = y;
        if(img == null) {
            img = ImageMaster.loadImage(TheVixenMod.getResourcePath("ui/intent/facadeintent.png"));
        }
