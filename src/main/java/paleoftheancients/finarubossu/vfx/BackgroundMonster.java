...
public class BackgroundMonster extends AbstractGameEffect {
    ...
    private static AbstractCreature RandomEntity() {
        ...
        possibilities.add(BardBoss.class);
        //possibilities.add(TheVixenBoss.class);
        //possibilities.add(TheShowmanBoss.class);
        possibilities.add(IronCluck.class);
    ...
    private static SpineAnimationEntity getSpineEntity(Class clz) {
        if(!data.containsKey(clz)) {
            ...
            } else if (BardBoss.class.equals(clz)) {
                data.put(clz, new BardBoss());
            } else if (IronCluck.class.equals(clz)) {
                data.put(clz, new IronCluck());
